...
def main():
    ...
    parser.add_argument('--model_path', type=str, 
                       default='./save/alexnet/chestmnist/202606081322_reg_ablation_Dp_0.1_iid_True_wm_enhanced_ep_150_le_2_cn_5_fra_1.0000_auc_0.7706_drift_margin_enhanced.pkl',
                       help='模型文件路径')
